...
- **`04_INTERIORES/ZC-INT-001_Projeto_Interiores_Casulo.pdf`** (`.html`, `tools/build_interiores.py`; pranchas em `cocoon/interiores/`, `tools/interiores_cocoon.py`) — projeto de interiores do Casulo com marcenaria acoplada: IN-01 planta de layout de interiores cotada (MA-01 a MA-08 fixos, MS-01 a MS-09 soltos), IN-02 paginação de pisos e acabamentos, IN-03/04 elevações internas A a D, IN-05 detalhes da marcenaria (Ilha do Café, armário na curva, cabeceira com criados suspensos, bancada), IN-06 quadro de mobiliário; memorial, quadros e FF&E. Anexado como seção 25 do documento técnico.
