...
def cocoon_fachada_traseira():
    ...
    sh.leader(-2.0, 1.4, L, 1.65, "Olho da banheira 0,80 x 0,55 (lateral, em escorco)", 12, anchor="end")
    ...
    sh.leader(2.25, 1.95, R, 2.85, "Olho do banho 0,80 x 0,55 (escorco)", 12, anchor="start")
