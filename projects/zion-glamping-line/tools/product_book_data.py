...
def cocoon_parts():
    ...
    BT = C.bico_tube_lengths()
    add("B09", "Bico: cumeeira em balanço (de A1 à ponta, 2,40 m além de A0)", 1, round(BT["ridge"], 2), 0, 0, "Tubo Ø114,3 x 4,0 curvado (ponta erguida 0,30 m)", "ASTM A500 Gr. B galv.", 4.0, BT["ridge"] * KG["Ø114,3 x 4,0"] + 3.0, "Calandra suave + chapas de engaste soldadas", "Engaste em A0 e A1 por chapas 10 mm + 4 M16 cada (nó de momento) ⚠️", 6, "Sustenta a ponta do Bico em balanço sobre o deck")
    add("B10-E", "Bico: tubo de borda esquerdo (ponta → anel A0)", 1, round(BT["edge"], 2), 0, 0, "Tubo Ø60,3 x 3,0 curvado em 3D", "ASTM A500 Gr. B galv.", 3.0, BT["edge"] * KG["Ø60,3 x 3,0"] + 0.8, "Curvamento CNC por gabarito 3D + ponteiras", "Nó soldado na ponta (B09) + chapa D01-B no anel A0 (2 M12)", 6, "Borda rígida do Bico; recebe o keder da membrana")
    add("B10-D", "Bico: tubo de borda direito", 1, round(BT["edge"], 2), 0, 0, "Tubo Ø60,3 x 3,0 curvado em 3D", "ASTM A500 Gr. B galv.", 3.0, BT["edge"] * KG["Ø60,3 x 3,0"] + 0.8, "Idem", "Idem", 6, "Idem")
    add("B11", "Bico: costela intermediária (a 50 % do balanço)", 1, round(BT["rib"], 2), 0, 0, "Tubo Ø48,3 x 3,0 curvado", "ASTM A500 Gr. B galv.", 3.0, BT["rib"] * KG["Ø48,3 x 3,0"] + 0.6, "Curvamento CNC + ponteiras M16", "Talão D03 na cumeeira e nas bordas", 7, "Trava as bordas e dá forma à membrana do Bico")
    add("B12", "Bico: tirante Ø12 inox (cumeeira a 60 % → anel A0 a ±0,80 rad)", 2, round(BT["tie"], 2), 0, 0, "Cabo inox AISI 316 Ø12 7 x 19", "inox 316", 12.0, BT["tie"] * 0.58 + 0.9, "Terminais prensados com olhal", "Olhal D05 + manilha + esticador M16 inox", 7, "Reduz a flecha e a vibração da ponta em balanço ⚠️")
    for i in range(1, 8):
        li = L[i]
