...
def planta(human=True):
    ...
    if human:
        ...
        sh.leader(4.9, -3.05, 4.5, -3.95, "Janelas Olho 0,95 x 0,80 (basculantes)", 11)
...
def elev_lateral():
    ...
    sh.leader(4.9, 1.5, 3.4, -1.15, "Janela Olho 0,95 x 0,80 com requadro de madeira 220 mm", 12, anchor="end")
    sh.leader(7.9, 2.0, 7.6, 3.9, "Olho do banho 0,80 x 0,55 (alto)", 12, anchor="end")
