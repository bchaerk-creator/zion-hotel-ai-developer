...
ITEMS = {
    ...
    "M19": ("Cama king com dossel (Bali)", "Estrutura em teca ou bambu laminado 2,03 x 1,93 com 4 colunas até 2,40 m, quadro superior e véu de voile branco nas 4 faces (mosquiteiro); colchão molas ensacadas 32 cm", "un", 14500, "M"),
    "M20": ("Tablado de madeira", "Plataforma 2,45 x 2,50 x 0,15 em teca ripada com LED indireto no rodapé", "un", 3800, "M"),
    "M21": ("Cadeira suspensa de rattan", "Cadeira suspensa em rattan natural com almofada de linho, suporte no quadro do dossel / arco A1", "un", 3400, "M"),
    "M22": ("Futon e almofadas de chão", "2 futons 1,00 x 1,10 em linho + 8 almofadas em kilim e algodão cru", "cj", 3900, "M"),
    "M23": ("Mesa baixa de tronco", "Tronco de madeira de demolição Ø0,65 x 0,32, acabamento natural", "un", 2100, "M"),
    ...
    "F11": ("Cortinas laterais em voile + blackout", "Voile de linho com barra de macramê em trilho curvo + blackout motorizado, por metro linear do cinturão transparente", "m", 1150, "F"),
    "F12": ("Luminárias de rattan e lanternas", "2 pendentes de rattan, 4 lanternas de latão com vela LED, arandelas de cerâmica", "cj", 3600, "F"),
    "F13": ("Tapetes de juta e kilim", "Tapete de juta 2,50 x 3,00 + kilim 1,60 x 2,30 + passadeira do banho", "cj", 3200, "F"),
    "F14": ("Curadoria Bali", "Macramês, cestaria, cerâmica artesanal, esculturas em madeira, tecidos batik", "vb", 5200, "F"),
    ...
    "D08": ("Daybed suspenso do deck", "Daybed 2,00 x 1,20 em teca e corda náutica pendurado na cumeeira do Bico, almofadas outdoor", "un", 7800, "D"),
...
LISTS = {
    ...
    "cocoon_s": [("M19", 1, "Suíte", "no cinturão transparente, pés para o vidro"), ("M20", 1, "Suíte", ""), ("M03", 2, "Suíte", "criados baixos em teca"), ("M16", 6, "Banho", "parede do banho, lado do banho"),
                 ("M22", 1, "Lounge", "sob o Bico"), ("M23", 1, "Lounge", ""), ("M21", 1, "Lounge", ""), ("M18", 1, "Cozinha", "mini cozinha em L atrás, junto ao banho"), ("M10", 1, "Closet", "closet 1,10 m à direita"),
                 ("M12", 1, "Banho", "bancada 1,50 m"), ("M13", 1, "Banho", ""),
                 ("F01", 2, "Suíte", ""), ("F12", 1, "Geral", ""), ("F13", 1, "Estar · suíte", ""), ("F11", 9.6, "Cinturão transparente", "2 vãos x 2 lados ≈ 9,6 m de trilho"), ("F06", 6.5, "Fachada", "voile na fachada de vidro"), ("F07", 1, "Espinha de Luz", ""), ("F14", 1, "Geral", ""), ("F10", 1, "Geral", "plantas em vasos de barro"),
                 ("E16", 1, "Cozinha", ""), ("E13", 1, "Cozinha", ""), ("E14", 1, "Cozinha", ""), ("E15", 1, "Cozinha", ""), ("E17", 1, "Cozinha", ""), ("E02", 1, "Cozinha", ""), ("E03", 1, "Closet", ""), ("E04", 1, "Lounge", ""), ("E06", 1, "Banho", ""), ("E10", 1, "Porta PV1", ""), ("E11", 1, "Ático técnico", ""),
                 ("O01", 1, "Suíte", ""), ("O02", 1, "Banho", ""), ("O03", 1, "Banho", ""), ("O04", 1, "Cozinha", ""), ("O09", 1, "Cozinha", ""), ("O05", 1, "Geral", ""), ("O06", 1, "Geral", ""), ("O07", 1, "Geral", ""), ("O08", 1, "Geral", ""),
                 ("D08", 1, "Deck", "sob o Bico"), ("D02", 1, "Deck", ""), ("D04", 1, "Deck", ""), ("D05", 1, "Deck", ""), ("D06", 1, "Deck", "opcional: banheira externa"),
                 ("B01", 1, "Banho", ""), ("B02", 1, "Banho", ""), ("B03", 1, "Banho", "")],
