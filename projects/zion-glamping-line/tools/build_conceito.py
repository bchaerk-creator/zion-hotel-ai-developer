...
UNITS = [
    dict(code="cocoon", tag="ZC", name="ZION CASULO", fam="Cabana biomórfica em casulo", cat="SIGNATURE", area=48.0, ext=29.9, guests="2 + 1", bed="1 king",
         ...
         sig=["Espinha de Luz: clarabóia contínua de 4,70 m na cumeeira, sobre a cama e o estar", "Bico: a membrana continua 2,40 m além do anel frontal, em balanço sobre o deck, e a ponta se ergue a 4,42 m: uma pontinha que abriga o deck e dá ao casulo a expressão de asa", "Seis Janelas Olho: lentes elípticas de 0,95 x 0,80 m, recortadas na membrana, cada uma emoldurando um pedaço de mata", "Cauda com banheira: o banho ocupa a ponta afilada, sob um Olho, com vista privada"],
