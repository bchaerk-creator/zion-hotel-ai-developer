...
|---|---|---|
| `contrato-zeladoria-mediterraneo.*` | Contrato principal, 18 cláusulas, objeto modular (Módulos A a F) | Assinatura (2 vias + 2 testemunhas) |
...
4. Assinalar no Anexo I os módulos contratados (A conservação · B paisagismo · C hospitalidade · D manutenção · E zeladoria e ronda · F recebimento de valores) e preencher perímetro, frequências, janelas e SLA
