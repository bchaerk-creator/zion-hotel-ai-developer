...
export const photos = {
  ...
  flo_interior: { file: "flo_interior.jpg", alt: "Interior da bubble em Florianópolis, com palmeiras e céu através da cúpula" },
  flo_zenital: { file: "flo_zenital.jpg", alt: "Sede de Florianópolis vista de cima: bubbles, deck e piscina" },
  flo_bubbles: { file: "flo_bubbles.jpg", alt: "Bubbles entre palmeiras, Florianópolis" },
  aerea_araucaria: { file: "aerea_araucaria.jpg", alt: "Mata de araucárias vista de drone, com a bubble ao fundo" },
